...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.1.21', '5.161.67.122', 'app.rfexposure.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                    ...
                    os.path.join(BASE_DIR, 'appauth/templates'),
                ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Use console email in development so signup does not try to connect to localhost SMTP.
...
# Only apply secure settings if we are NOT in templates/local development
if not DEBUG:
    ...
    # Ensure these are False while working on your hard drive
